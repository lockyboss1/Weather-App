...
var longitude;
var latitude;
var isCacheSupported = 'caches' in window;
var cacheName = 'weatherForecast'; //gets the current date and time
...
getDate(); //function to convert time from UNIX time to EPOCH time
...
form.addEventListener("submit", function (e) {
  ...
  for (var i = 0; i < p.length; i++) {
    ...
    p[i].addEventListener('click', function (e) {
      console.log(i);
      var city = document.querySelector('.city');
      modal.style.display = "block"; //city.remove();
